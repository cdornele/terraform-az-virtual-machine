...
output "windows_vm_public_ips" {
  ...
  value       = var.vm_isWindows && var.vm_public_ip_enabled ? azurerm_windows_virtual_machine.windows-vm.*.public_ip_address_ip_address : null
}
...
output "linux_vm_public_ips" {
  ...
  value       = !var.vm_isWindows && var.vm_public_ip_enabled ? azurerm_linux_virtual_machine.vm-linux.*.public_ip_address_ip_address : null
}
